...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and ORG pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and ORG pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from ORG pool', data)
  }
