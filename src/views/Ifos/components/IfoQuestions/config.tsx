...
const config = [
  {
    ...
    description: [
      <Trans>
        ...
        ORG up to the maximum commit limit, which is published along with the IFO voting proposal. The Private Sale has
        no participation fee.
      </Trans>,
      <Trans>
        In the Public Sale, everyone with an active PancakeSwap profile can commit. However the maximum amount of ORG
        users can commit, is equal to the number of iCAKE they have.
      </Trans>,
      <>
        <Trans>Learn more about iCAKE</Trans>
        <InlineLink ml="4px" external href="https://orange-swap.gitbook.io/orange-swap-1/">
          <Trans>here</Trans>
        </InlineLink>
      </>,
  ...
  },
  {
    ...
    description: [<Trans>The ORG from the participation fee will be burnt as part of the weekly token burn.</Trans>],
  },
  {
    title: <Trans>How can I get an achievement for participating in the IFO?</Trans>,
    description: [
      <Trans>You need to contribute a minimum of about 10 USD worth of ORG to either sale.</Trans>,
      <Trans>
