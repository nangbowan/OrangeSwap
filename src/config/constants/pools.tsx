...
import { bscTokens,fonTokens } from '@pancakeswap/tokens'
...
export const vaultPoolConfig = {
  ...
  // [VaultKey.IfoPool]: {
  //   name: 'IFO ORG',
  //   description: <Trans>Stake ORG to participate in IFOs</Trans>,
