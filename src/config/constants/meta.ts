...
export const DEFAULT_META: PageMeta = {
  title: 'OrangeSwap',
  description:
    'OrangeSwap-A next evolution DeFi exchange on FON Smart Chain(FSC)  The most popular AMM on FSC! Earn ORG through yield farming or win it by trading, then stake it in Pools to earn more tokens! Initial Farm Offerings(new token launch model pioneered by OrangeSwap)NFTs, and more, on a platform you can trust.',
  image: 'https://orangeswap.org/images/base/banner2.png',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    ...
    defaultTitleSuffix: t('OrangeSwap'),
  }
}
