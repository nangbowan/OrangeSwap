...
export { default as MediaIcon } from "./Icons/MediaIcon";
export { default as MetaverseIcon } from "./Icons/Metaverse";
...
export { default as NftbarIcon } from "./Icons/Nftbaricon";
